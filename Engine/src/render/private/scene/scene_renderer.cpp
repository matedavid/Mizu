    ...
    for (uint32_t view_id = 0; view_id < m_num_render_views; ++view_id)
    {
        ...
        camera_allocation.upload(
            GpuCameraInfo{
                ...
                .view_proj = entry.view_proj_matrix,
                .inverse_view = glm::inverse(entry.view_matrix),
                .inverse_proj = glm::inverse(entry.proj_matrix),
                .inverse_view_proj = glm::inverse(entry.view_proj_matrix),
