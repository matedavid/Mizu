    ...
    void init() override
    {
        ...
        for (const AssimpLoader::MeshInfo& mesh_info : sponza_loader.get_meshes_info())
        {
            ...
            static_state.transform_handle =
                g_transform_state_manager2->sim_create({}, TransformDynamicState{.scale = glm::vec3(0.05f)});
            ...
            const StaticMeshHandle mesh_handle = g_static_mesh_state_manager2->sim_create(static_state, {});
...

        {
            ...
            ss.transform_handle = g_transform_state_manager2->sim_create(
            ...
            m_suzanne_handle0 = g_static_mesh_state_manager2->sim_create(ss, {});
...

        {
            ...
            m_suzanne_handle1 = g_static_mesh_state_manager2->sim_create(ss, {});
        ...
        {
            const TransformHandle transform_handle = g_transform_state_manager2->sim_create(
            ...
            const LightHandle light_handle = g_light_state_manager2->sim_create(static_state, dynamic_state);
            ...
            g_static_mesh_state_manager2->sim_create(static_mesh_state, {});
        }
        ...
        // Create Directional light
        {
            ...
            dynamic_state.data.directional =
                LightDynamicState::Directional{.direction = glm::vec3(1.0f, -1.0f, 0.0f)};
    ...
    void update(double dt) override
    {
...

        {
            const TransformHandle& suzanne_transform_handle =
                g_static_mesh_state_manager2->get_static_state(m_suzanne_handle0).transform_handle;

            TransformDynamicState suzanne_ds =
                g_transform_state_manager2->sim_get_dynamic_state(suzanne_transform_handle);
            suzanne_ds.rotation.y = glm::radians(static_cast<float>(time * 10.0f));
            g_transform_state_manager2->sim_update(suzanne_transform_handle, suzanne_ds);
        }

        {
            const TransformHandle& suzanne_transform_handle =
                g_static_mesh_state_manager2->get_static_state(m_suzanne_handle1).transform_handle;
