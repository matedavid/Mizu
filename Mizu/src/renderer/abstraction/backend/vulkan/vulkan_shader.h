...
class VulkanGraphicsShader : public GraphicsShader, public VulkanShaderBase {
  public:
    ...
    [[nodiscard]] std::vectVkShaderModule m_vertex_module{VK_NULL_HANDLE};
    VkShaderModule m_fragment_module{VK_NULL_HANDLEor<VkVertexInputAttributeDescription>
get_vertex_input_attribute_descriptions() const { return m_vertex_input_attribute_descriptions;
    }
